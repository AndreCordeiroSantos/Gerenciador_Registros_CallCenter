    ...
    <main class="content">
        ...
        <div class="container">
            <div class="card card-body border-1 shadow mb-4">
                ...
                $sql = "SELECT id, et, numserie, motivo, status, usuario FROM sua_tabela ORDER BY id DESC";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "SELECT status FROM sua_tabela WHERE id=:id";
            $stmt = $con->prepare($sql);
            ...
            Swal.fire({
              ...
              window.location.href = 'paineluser.php';
                    ...
                    $sql = "UPDATE sua_tabela SET usuario=:usuario, status = 'registrado', req=:req WHERE id=:id";
                    $stmt = $con->prepare($sql);
