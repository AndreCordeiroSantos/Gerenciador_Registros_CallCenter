            ...
            <div class="card card-body border-0 shadow mb-4">
                ...
                <table id="minhaTabela">
                    ...
                    <tbody>
                        ...
                        $sql1 = "SELECT id, p_descricao, p_quantidade, p_solicitante, p_responsavel, p_data, p_req, p_status FROM sua_tabela ORDER BY id DESC";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (empty($peca) || empty($numserie) || empty($solicitante) || !preg_match('/^REQ/', $req) || empty($observacao)) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        $sql = "INSERT INTO sua_tabela (p_descricao, p_numserie, p_solicitante, p_data, p_status, p_quantidade, p_req, p_observacao)
