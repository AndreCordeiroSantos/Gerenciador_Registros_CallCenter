...
<body>
  ...
  Swal.fire({
            ...
            <div class="card card-body border-1 shadow mb-4">
                ...
                <table id="minhaTabela">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT id, p_descricao, p_quantidade, p_solicitante, p_responsavel, p_data, p_req, p_status 
                            FROM sua_tabela 
                            ORDER BY id DESC";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE sua_tabela SET p_status = 'em andamento', p_responsavel=:responsavel WHERE id=:id";
