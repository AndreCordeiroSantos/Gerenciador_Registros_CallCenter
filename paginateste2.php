    ...
    <main class="content">
        ...
        <div class="card card-body border-1 shadow mb-4 mb-xl-0">
            ...
            <table id='minhatabela' class='display'>
                <thead>
                    <tr>
                        <th class='nome-logico'>Estação</th>
                        <th class='num-serie'>Num/Série</th>
                        <th>Baia</th>
                        <th class='userinv'>Usuário</th>
                        <th>Domínio</th>
                        <th class='processs'>Processador</th>
                        <th>Memória</th>
                        <th>IP ATUAL</th>
                ...
                <tbody>
                    <!-- Os dados da tabela devem ser adicionados aqui -->
                </tbody>
            </table>
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('table.display').DataTable({
                    ...
                    ajax: {
                        url: '/archerx/public/wyntech/funcoes/dataxaxim.php',
                        dataSrc: ''
                    },
                    rowId: 'id',
